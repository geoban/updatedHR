 ...
 * @author ideapad 520
 */
public class Asset_and_amenities_Form extends javax.swing.JFrame {

    /**
     * Creates new form loginForm
     */
    public Asset_and_amenities_Form() {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html>Asset and Amenities <br/>Management Division<html>");
    ...
    private void jLabel_createMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_createMouseClicked
        //asset create account clicked
        
        registrationForm rf = new registrationForm();
        rf.setVisible(true);
        rf.pack();        
        rf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        rf.formNumber = 4;// pass 4 to registration form to know that this is coming from asset
        this.dispose();
