 ...
 * @author ideapad 520
 */
public class Administrative_division_Form extends javax.swing.JFrame {
     ...
     */
    public Administrative_division_Form() {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Administrative Division");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton_show, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE)
    ...
    private void jButton_loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_loginButtonActionPerformed
        ...
        String query = "SELECT * FROM `admin_table` WHERE `idNumbers` = ? AND `password` = ?";
        
        try {
            //ps = admin_db.getConnection().prepareStatement(query);
