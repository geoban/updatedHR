 ...
 * @author ideapad 520
 */
public class registrationForm8 extends javax.swing.JFrame {

    /**
     * Creates new form registrationForm
     */
    public registrationForm8() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(verifyFields())
        {
            ...
            String registrationUserQuery = "INSERT INTO `user`(`first name`, `last name`, `birth date`, `gender`, `address`, `contact`, `fatherfname`, `fatherlname`, `motherfname`, `motherlname`, `ssnumber`, `tax`,`position`, `unit / division`, `idNumbers`, `password`, `confirm password`) "
                    + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            try{
                ps = public_db.getConnection().prepareStatement(registrationUserQuery);
    ...
    public boolean checkidNumbers(String id){
        ...
        try {
            ps = public_db.getConnection().prepareStatement(query);
            ps.setString(1, id);
            rs = ps.executeQuery();
