 ...
 * @author ideapad 520
 */
public class Info_and_comm_Form extends javax.swing.JFrame {

    /**
     * Creates new form loginForm
     */
    public Info_and_comm_Form() {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Information and Communitcation Login");
    ...
    private void jButton_loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_loginButtonActionPerformed
        ...
        String query = "SELECT * FROM `info_table` WHERE `idNumbers` = ? AND `password` = ?";
