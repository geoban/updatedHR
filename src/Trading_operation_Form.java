 ...
 * @author ideapad 520
 */
public class Trading_operation_Form extends javax.swing.JFrame {

    /**
     * Creates new form loginForm
     */
    public Trading_operation_Form() {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Trading Operation");
    ...
    private void jButton_loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_loginButtonActionPerformed
        ...
        String query = "SELECT * FROM `trading_table` WHERE `idNumbers` = ? AND `password` = ?";
