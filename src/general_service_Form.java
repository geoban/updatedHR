 ...
 * @author ideapad 520
 */
public class general_service_Form extends javax.swing.JFrame {

    /**
     * Creates new form loginForm
     */
    public general_service_Form() {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("General Service Unit");
    ...
    private void jButton_loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_loginButtonActionPerformed
        ...
        String query = "SELECT * FROM `general_table` WHERE `idNumbers` = ? AND `password` = ?";
