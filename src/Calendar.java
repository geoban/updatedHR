 ...
 * @author ideapad 520
 */
public class Calendar extends CalendarManager{
    JFrame mainFrame;
	...
	final String SaveButMsg1 = "Saved ";
	final String SaveButMsg2 = "Write Something ";
	final String DelButMsg1 = "Deleted";
	final String DelButMsg2 = "Memo is empty nothing to delete";
	final String ClrButMsg1 = "Cleared";
	...
	public Calendar(){
		...
		calOpPanel = new JPanel();
			...
			todayLab = new JLabel(today.get(java.util.Calendar.MONTH)+1+"/"+today.get(java.util.Calendar.DAY_OF_MONTH)+"/"+today.get(java.util.Calendar.YEAR));
		...
		infoPanel = new JPanel();
			...
			selectedDate = new JLabel("<Html><font size=3>"+(today.get(java.util.Calendar.MONTH)+1)+"/"+today.get(java.util.Calendar.DAY_OF_MONTH)+"/"+today.get(java.util.Calendar.YEAR)+"&nbsp;(Today)</html>", SwingConstants.LEFT);
	...
	private void focusToday(){
		if(today.get(java.util.Calendar.DAY_OF_WEEK) == 1)
			dateButs[today.get(java.util.Calendar.WEEK_OF_MONTH)][today.get(java.util.Calendar.DAY_OF_WEEK)-1].requestFocusInWindow();
		else
			dateButs[today.get(java.util.Calendar.WEEK_OF_MONTH)-1][today.get(java.util.Calendar.DAY_OF_WEEK)-1].requestFocusInWindow();
	}
	...
	private void showCal(){
		for(int i=0;i<CAL_HEIGHT;i++){
			for(int j=0;j<CAL_WIDTH;j++){
				...
				if(calMonth == today.get(java.util.Calendar.MONTH) &&
	...
	private class listenForDateButs implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if(dDay == 0 && (cal.get(java.util.Calendar.YEAR) == today.get(java.util.Calendar.YEAR)) 
					...
					&& (cal.get(java.util.Calendar.DAY_OF_MONTH) == today.get(java.util.Calendar.DAY_OF_MONTH))) dDayString = "Today"; 
			...
			while(true){
				try{
					...
					String hour;
							...
							else hour = (today.get(java.util.Calendar.HOUR)<10?" ":"")+today.get(java.util.Calendar.HOUR);
