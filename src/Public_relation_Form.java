 ...
 * @author ideapad 520
 */
public class Public_relation_Form extends javax.swing.JFrame {

    /**
     * Creates new form loginForm
     */
    public Public_relation_Form() {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Public Relation");
    ...
    private void jButton_loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_loginButtonActionPerformed
        ...
        String query = "SELECT * FROM `publics_table` WHERE `idNumbers` = ? AND `password` = ?";
