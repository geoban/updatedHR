 ...
 * @author ideapad 520
 */
public class registrationForm3 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(verifyFields())
        {
            ...
            ResultSet rs;
            String registrationUserQuery = "INSERT INTO `chief_table`(`first name`, `last name`, `birth date`, `gender`, `address`, `contact`, `fatherfname`, `fatherlname`, `motherfname`, `motherlname`, `ssnumber`, `tax`,`position`, `unit / division`, `idNumbers`, `password`, `confirm password`) "
                    + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            try{
    ...
    public boolean checkidNumbers(String id){
        ...
        String query = "SELECT * FROM `asset_table` WHERE `idNumbers` = ?";
